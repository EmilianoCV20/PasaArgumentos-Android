...
public class MainActivity extends AppCompatActivity {
    ...
    final static int USUARIO_CODIGO    = 1024;  // Valor arbitrario para el campo Usuario
    final static int CONTRASENA_CODIGO = 2048;  // Valor arbitrario para el campo Contraseña
    ...
    public void btnIngresarClick ( View v ) {
        Toast.makeText (
         this,
           "Bienvenido: " + edtUsuario.getText().toString() + ", " + edtContrasena.getText()
